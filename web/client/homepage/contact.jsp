                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                ...
                                <p class="mb-4">Nếu quý khách có thắc mắc hay câu hỏi gì vui lòng liên hệ thông tin dưới đây.<a class="d-flex justify-content-center" href="https://www.facebook.com/Hyluv1801/">Nhắn tin ngay</a>.</p>
                            </div>
                        </div>
<!--                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">support@laptopshop.com</p>
                                </div>
                            </div>
